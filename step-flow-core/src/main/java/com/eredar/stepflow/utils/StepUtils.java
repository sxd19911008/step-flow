...
import com.eredar.stepflow.exception.StepException;
...
public class StepUtils {
    ...
    public static Map<String, String> getParamNameMap(OneOffStepParams oneOffStepParams) {
        if (oneOffStepParams == null) return null;
        return oneOffStepParams.getParamNameMap();
    }
    ...
    public static <T> T getValByMap(String key, Map<String, Object> map, Class<T> clazz, boolean isCheckNull) {
        ...
        if (o == null) {
            if (isCheckNull) {
                throw new StepException(String.format("key【%s】对应的参数为null", key));
            }
            return null;
        }
